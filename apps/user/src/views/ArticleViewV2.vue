...
import ArticleDetailComponentV2 from "../components/Article/v2/ArticleDetailComponentV2.vue";
...
<template>
  <div class="article-v2-page" :class="{ 'theme-dark': isDarkMode, 'theme-light': !isDarkMode }">
...
.theme-light .article-v2-page {
  background: linear-gradient(135deg, #fafbfc 0%, #f5f7fa 100%);
  color: #333333;
}

.theme-dark .article-v2-page {
